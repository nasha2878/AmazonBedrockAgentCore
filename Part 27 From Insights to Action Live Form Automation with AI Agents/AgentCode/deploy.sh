...
# Configuration
ACCOUNT_ID="<<ACCOUNTID>>" # REPLACE WITH YOUR ACCOUNT ID
REGION="us-east-1" # REPLACE WITH YOUR REGION
REPO_NAME="ebaagent"

echo " Deploying Execution Browser Agent Container (No Local Test)"
echo "================================================="

# Cleanup any existing containers
echo " Cleaning up existing containers..."
docker ps -aq --filter "name=ebaagent" | xargs -r docker rm -f 2>/dev/null || true
